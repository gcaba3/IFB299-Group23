  ...
  <div class="shadow rounded-corners clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class="clearfix colelem" id="u2903-34"><!-- content -->
     <h2 id="u2903-2"><span class="actAsDiv normal_text" id="u2904"><!-- content --><span class="actAsDiv" id="u2905"><!-- simple frame --></span></span><span id="u2903">Sponsors</span></h2>
    <?php
...
$sql = "SELECT `Sponsor Name`, `Email` FROM `Sponsors`;";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<br> Name: ". $row["Sponsor Name"]. " - email: ". $row["Email"]. " <br>";
     }
} else {
     echo "0 results";
}
...
<form id="form_1162732" class="appnitro"  method="post" action="">
			...
			<ul >
					...
					<li id="li_2" >
		<label class="description" for="element_2">Sponsor ID </label>
		<div>
			<input id="element_2" name="element_2" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_3" >
		<label class="description" for="element_3">Events </label>
		<div>
...
?>  
		...
		<label class="description" for="element_1">Ammount to Donate </label>
		<div>
			<input id="element_1" name="element_1" class="element text medium" type="text" maxlength="255" value=""/> 
					...
					<li class="buttons">
			    <input type="hidden" name="form_id" value="1162732" />
