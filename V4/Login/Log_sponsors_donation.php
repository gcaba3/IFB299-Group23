...
<html class="nojs html css_verticalspacer" lang="en-US">
 <head>
  <title>Log Sponsors donation</title>
...
?>
    ...
    <div class="clearfix colelem" id="u2903-34"><!-- content -->
     ...
     <h2 id="u2903-2"><span class="actAsDiv normal_text" id="u2904"><!-- content --><span class="actAsDiv" id="u2905"><!-- simple frame --></span></span><span id="u2903">Log Sponsors Donation</span></h2>
     <p id="u2903-3">&nbsp;</p>
     <p id="u2903-4">&nbsp;</p>
     <p id="u2903-5">&nbsp;</p>
     <p id="content">
 ...
 <div class="FullBody" style="text-align:center;">
        <form method="post" action="">
          <p class="larger"> Choose which event the sponsor donated to: </p>
          <p class="larger">
            <select name="event">
                <?php
          ...
          <p class="larger">Enter the value of the donation</p>
            <p><input name="amount" type="number" required="required" id="amount" placeholder="Enter Amount here" min='1'></p>
          <p class="larger"><input type="submit" value="Confirm" name="submit" id="submit"></p>
        </form>
        </div>
     </p> <!---End of Content--->
