...
?>
    ...
    <div class="clearfix colelem" id="u2903-34"><!-- content -->
     ...
     <p id="u2903-3">&nbsp;</p>
     <p id="u2903-4">&nbsp;</p>
     <p id="u2903-6">1.How do I create a account?</p>
     <p id="u2903-7">&nbsp;</p>
     <p id="u2903-9">&nbsp;Head over to the login tab, then select create a account and fill in your details.</p>
     <p id="u2903-10">&nbsp;</p>
     <p id="u2903-12">2. When I dontate is my payment secure?</p>
     <p id="u2903-13">&nbsp;</p>
     <p id="u2903-15">Yes here at Community Organisation, your security is important. Our payment service goes through the widely used and secure Visa and Paypal payment services.</p>
     <p id="u2903-16">&nbsp;</p>
     <p id="u2903-18">3. Do you have a application for mobiles?</p>
     <p id="u2903-19">&nbsp;</p>
     <p id="u2903-21">Currently we do not have a mobile application, but we will be working on that in the near future. Our website however is mobile compatible so you can access our website and all its features on any mobile device.</p>
     <p id="u2903-22">&nbsp;</p>
     <p id="u2903-24">4. What can I do as a member?</p>
     <p id="u2903-25">&nbsp;</p>
     <p id="u2903-27">As a member you can view various events and express your interest. If you have chosen to attend a event it will be displayed to your account and you can see all the events you are attending. You can also donate to events, and see the donations you have contributed.</p>
     <p id="u2903-22">&nbsp;</p>     
     <p id="u2903-24">5. How can I volunteer to an event?</p>
     <p id="u2903-25">&nbsp;</p>
     <p id="u2903-27">First you're going to have to get in contact with one of the planners. They will then enter your email into our system, after which you will receive an email containg a username and password of your account. Once you receive the email you will have to login and finish your account. After this is done, you are then registered as a volunteer.</p>
     <p id="u2903-22">&nbsp;</p>     
     <p id="u2903-24">6. How do I know what event I'm volunteering to?</p>
     <p id="u2903-25">&nbsp;</p>
     <p id="u2903-27">After you log-in to your volunteer account, you can click on the event page. In which you will see the event your assigned to or an error message. If you receive the error message it means the planners haven't assigned you to any events.</p>
     <p id="u2903-22">&nbsp;</p>     
     <p id="u2903-24">7. How can I sponsor an event?</p>
     <p id="u2903-25">&nbsp;</p>
     <p id="u2903-27">First you will have to get in contact with one of our planners. In which you will exchange information details. They will then create a sponsor account to keep track of your donations. With this account the planner can keep a log of your donations. Sponsor's can't directly donate to events via the website, so as a sponsor you will have to transfer money to the community organization, after the transfer has cleared the planner can then log the donation into our system..</p>
