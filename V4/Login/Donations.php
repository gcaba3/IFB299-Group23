...
?>
    ...
    <div class="clearfix colelem" id="u2903-34"><!-- content -->
     ...
     <h2 id="u2903-2"><span class="actAsDiv normal_text" id="u2904"><!-- content --><span class="actAsDiv" id="u2905"><!-- simple frame --></span></span><span id="u2903">Member's Donation Summary</span></h2>
     <p id="u2903-3">&nbsp;</p>
     <p id="u2903-4">&nbsp;</p>
     <p id="u2903-5">&nbsp;</p>
     <p id="content">
       ...
       <table style="width:100%" border="0"> 
        ...
        <div style="text-align:center">
            <form action = "" method= "post">
                <p><input style="margin-top:10px; margin-bottom:10px;"  type="submit" name="add_new" id="add_new" value="Add New"></p>
