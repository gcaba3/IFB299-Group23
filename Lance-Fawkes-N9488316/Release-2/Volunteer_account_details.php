...
$volunteer_account_number = $_SESSION['v_accountnumber'];
$error_message = FALSE;
$empty_field = FALSE;
...
if(isset($_POST['save'])){
	...
	if($_POST['f_name'] == "" || $_POST['l_name'] == "" || $_POST['email'] == "" || $_POST['phonenumber'] == ""){
		...
		$sql = "INSERT INTO volunteer (Account_number, FirstName, LastName, PhoneNumber, Email)
			VALUES ('$volunteer_account_number', '$first_name', '$last_name', '$phonenumber', '$email')";
	...
	$sql2 = "DELETE FROM account 
			WHERE Account_number = '$volunteer_account_number'";
