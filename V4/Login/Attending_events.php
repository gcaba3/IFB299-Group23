...
?>
    ...
    <div class="clearfix colelem" id="u2903-34"><!-- content -->
     ...
     <h2 id="u2903-2"><span class="actAsDiv normal_text" id="u2904"><!-- content --><span class="actAsDiv" id="u2905"><!-- simple frame --></span></span><span id="u2903">Attending Events</span></h2>
     <p id="u2903-3">&nbsp;</p>
     <p id="u2903-4">&nbsp;</p>
     <p id="u2903-5">&nbsp;</p>
     <p id="content">
...
<div class="FullBody">
        ...
        <p style="margin-top:10px; text-align:center;">Note Ticket Price(s) are only released after registration is closed. </p>
  </div>
  </div>
     </p> <!---End of Content--->
