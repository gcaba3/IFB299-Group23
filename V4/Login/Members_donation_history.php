...
<html class="nojs html css_verticalspacer" lang="en-US">
 <head>
  <title>Members Donation History</title>
...
?>
    ...
    <div class="clearfix colelem" id="u2903-34"><!-- content -->
     ...
     <h2 id="u2903-2"><span class="actAsDiv normal_text" id="u2904"><!-- content --><span class="actAsDiv" id="u2905"><!-- simple frame --></span></span><span id="u2903">Members Donation History</span></h2>
     <p id="u2903-3">&nbsp;</p>
     <p id="u2903-4">&nbsp;</p>
     <p id="u2903-5">&nbsp;</p>
     <p id="content">
 ...
 <div class="FullBody" style="text-align:center;">
        ...
        <div style="text-align:center">
            <form action = "" method= "post">
                <p class="larger"><input  type="submit" name="add_new" id="add_new" value="Add New"></p>
            </form>
            
        <p class="larger"><a href="Donations.php"> Return </a></p>
        </div>
        </div>
     </p> <!---End of Content--->
